                ...
                sortedApps.forEach(app => {
                    ...
                    let actionsHtml = `
                        <div class="admin-action-row-mob" style="display:flex; gap: 6px; justify-content: flex-end; align-items: center; flex-wrap: wrap; margin-top: 12px;">
                            ...
                            <button type="button" class="btn btn-sm btn-toggle-bizitem-mob" data-id="${app.id}" onclick="event.stopPropagation(); event.preventDefault(); window.toggleBizItemMob('${app.id}', this); return false;" ontouchstart="event.stopPropagation();" style="padding: 6px 12px; font-size: 0.85rem; border-radius: 6px; font-weight: 700; height: 36px; touch-action: manipulation; ${(app.isBizItem === true || String(app.isBizItem) === 'true') ? 'background: #0284c7; color: white; border: none;' : 'background: #f8fafc; color: #475569; border: 1px solid #cbd5e1;'}">
                            ...
                            <button type="button" class="btn btn-secondary btn-sm btn-delete-app-mob" data-id="${app.id}" onclick="event.stopPropagation(); event.preventDefault(); window.deleteApplicationAdminMob('${app.id}', this, event); return false;" ontouchstart="event.stopPropagation();" style="padding: 6px 10px; font-size: 0.85rem; border: 1px solid #fecaca; color: #dc2626; background: #fee2e2; border-radius: 6px; height: 36px; touch-action: manipulation;"><i class="fa-solid fa-trash-can"></i> 삭제</button>
                        </div>
                    `;
